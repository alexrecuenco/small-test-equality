...
export async function asyncDeepEquals(o: JSONParseable, u: JSONParseable): Promise<boolean> {
  ...
  if (
    (o && u && o instanceof Object && u instanceof Object) ||
    (o != null && typeof o == 'object' && u != null && typeof u == 'object')
  ) {
    ...
    if (obj1Length === obj2Length) {
      ...
      if (o instanceof Date || Array.isArray(o) || u instanceof Date || Array.isArray(u)) {
        if (o instanceof Date && u instanceof Date) {
          ...
          const Array1: string[] = []; //for date arrays, explicitly saving in string array upon converting all date values to string
          const Array2: string[] = [];
